...
class KokuHTTPClientTest(TestCase):
    ...
    def test_create_provider(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                "http://www.koku.com/api/cost-management/v1/providers/", status_code=201, json={"uuid": expected_uuid}
            )
    ...
    def test_create_provider_with_source_uid(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                "http://www.koku.com/api/cost-management/v1/providers/", status_code=201, json={"uuid": source_uuid}
            )
    ...
    def test_create_provider_exceptions(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                "http://www.koku.com/api/cost-management/v1/providers/", status_code=400, json={"uuid": faker.uuid4()}
            )
    ...
    def test_create_provider_bad_permissions(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                "http://www.koku.com/api/cost-management/v1/providers/", status_code=401, json={"uuid": faker.uuid4()}
            )
            with self.assertRaises(KokuHTTPClientNonRecoverableError):
                client.create_provider(self.name, self.provider_type, self.authentication, self.billing_source)
    ...
    def test_destroy_provider(self):
        ...
        expected_uuid = faker.uuid4()
        with requests_mock.mock() as m:
            m.delete(f"http://www.koku.com/api/cost-management/v1/providers/{expected_uuid}/", status_code=204)
    ...
    def test_destroy_provider_exception(self):
        ...
        with requests_mock.mock() as m:
            m.delete(
                f"http://www.koku.com/api/cost-management/v1/providers/{expected_uuid}/",
    ...
    def test_destroy_provider_error(self):
        ...
        expected_uuid = faker.uuid4()
        with requests_mock.mock() as m:
            m.delete(f"http://www.koku.com/api/cost-management/v1/providers/{expected_uuid}/", status_code=400)
            with self.assertRaises(KokuHTTPClientError):
                client.destroy_provider(expected_uuid)
    ...
    def test_destroy_provider_not_found_error(self):
        ...
        with requests_mock.mock() as m:
            m.delete(
                f"http://www.koku.com/api/cost-management/v1/providers/{expected_uuid}/", status_code=404, json={}
            )
            with self.assertRaises(KokuHTTPClientNonRecoverableError):
                client.destroy_provider(expected_uuid)
    ...
    def test_update_provider(self):
        ...
        expected_uuid = faker.uuid4()
        with requests_mock.mock() as m:
            m.put(f"http://www.koku.com/api/cost-management/v1/providers/{expected_uuid}/", status_code=200, json={})
    ...
    def test_update_provider_error(self):
        ...
        expected_uuid = faker.uuid4()
        with requests_mock.mock() as m:
            m.put(f"http://www.koku.com/api/cost-management/v1/providers/{expected_uuid}/", status_code=400, json={})
            with self.assertRaises(KokuHTTPClientNonRecoverableError):
                client.update_provider(
                    expected_uuid,
                    "Aws Test",
    ...
    def test_update_provider_not_found_error(self):
        ...
        expected_uuid = faker.uuid4()
        with requests_mock.mock() as m:
            m.put(f"http://www.koku.com/api/cost-management/v1/providers/{expected_uuid}/", status_code=404, json={})
            with self.assertRaises(KokuHTTPClientNonRecoverableError):
                client.update_provider(
                    expected_uuid,
                    "Aws Test",
