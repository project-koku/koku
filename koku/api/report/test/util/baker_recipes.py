...
gcp_daily_summary = Recipe(
    ...
    usage_amount=fake.pydecimal(left_digits=14, right_digits=8, positive=True),
    unblended_cost=fake.pydecimal(left_digits=14, right_digits=8, positive=True),
    markup_cost=fake.pydecimal(left_digits=14, right_digits=8, positive=True),
    credit_amount=fake.pydecimal(left_digits=14, right_digits=8, positive=True),
    _fill_optional=True,
    _bulk_create=True,
