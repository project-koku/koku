...
gcp_daily_summary = Recipe(
    ...
    usage_amount=fake.pydecimal(left_digits=22, right_digits=8, positive=True),
    unblended_cost=fake.pydecimal(left_digits=22, right_digits=8, positive=True),
    markup_cost=fake.pydecimal(left_digits=22, right_digits=8, positive=True),
    credit_amount=fake.pydecimal(left_digits=22, right_digits=8, positive=True),
    _fill_optional=True,
    _bulk_create=True,
...
ocp_usage_pod = Recipe(  # Pod data_source
    ...
    pod_limit_cpu_core_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    pod_usage_cpu_core_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    pod_request_cpu_core_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    pod_limit_memory_gigabyte_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    pod_usage_memory_gigabyte_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    pod_request_memory_gigabyte_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    node_capacity_cpu_cores=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    node_capacity_cpu_core_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    node_capacity_memory_gigabytes=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    node_capacity_memory_gigabyte_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    cluster_capacity_cpu_core_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    cluster_capacity_memory_gigabyte_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
...
ocp_usage_storage = Recipe(  # Storage data_source
    ...
    persistentvolumeclaim_capacity_gigabyte=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    persistentvolumeclaim_capacity_gigabyte_months=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    volume_request_storage_gigabyte_months=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    persistentvolumeclaim_usage_gigabyte_months=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    node_capacity_cpu_cores=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    node_capacity_cpu_core_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    node_capacity_memory_gigabytes=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
    node_capacity_memory_gigabyte_hours=fake.pydecimal(left_digits=10, right_digits=5, positive=True),
