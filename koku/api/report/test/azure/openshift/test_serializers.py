...
from api.report.azure.openshift.serializers import (
    OCPAzureFilterSerializer,
    OCPAzureGroupBySerializer,
    OCPAzureOrderBySerializer,
    OCPAzureQueryParamSerializer,
)
...
class OCPAzureQueryParamSerializerTest(TestCase):
    ...
    def test_valid_delta_costs(self):
        ...
        serializer = OCPAzureQueryParamSerializer(
            data=query_params, context={'request': req}
        )
        self.assertTrue(serializer.is_valid())
