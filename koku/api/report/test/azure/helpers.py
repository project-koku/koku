...
#
AZURE_LOCATIONS = ['East Asia', 'Southeast Asia', 'Central US', 'East US',
                   'East US 2', 'West US', 'North Central US', 'South Central US',
                   'North Europe', 'West Europe', 'Japan West', 'Japan East',
                   'Brazil South', 'Australia East', 'Australia Southeast',
                   'South India', 'Central India', 'West India', 'Canada Central',
                   'Canada East', 'UK South', 'UK West', 'West Central US',
                   'West US 2', 'Korea Central', 'Korea South', 'France Central',
                   'France South', 'Australia Central', 'Australia Central 2',
                   'UAE Central', 'UAE North', 'South Africa North',
                   'South Africa West', 'Germany North', 'Germany West Central']

# {Consumed Service: [Resource Type]}
#
AZURE_RESOURCES = {'Microsoft.Storage': ['Microsoft.Storage/storageAccounts',
                                         'Microsoft.Storage/storageAccounts/blobServices'],
                   'Microsoft.Network': ['Microsoft.Network/publicIPAddresses',
...
AZURE_METERS = {'Bandwidth': {'null': ['Data Transfer In',
                ...
                'Storage': {'Bandwidth': ['Geo-Replication Data transfer',
                            ...
                            'Standard Page Blob': ['Disk Read Operations',
                                                   'Disk Write Operations',
                                                   'LRS Data Stored'],
                            'Standard SSD Managed Disks': ['Disk Operations',
                                                           'E4 Disks'],
                            'Tables': ['Batch Write Operations',
...
#
AZURE_INSTANCE_TYPES = ['Standard_B1ls', 'Standard_B1ms', 'Standard_B1s',
                        'Standard_B2ms', 'Standard_B2s', 'Standard_B4ms',
                        'Standard_B8ms', 'Standard_B12ms', 'Standard_B16ms',
                        'Standard_B20ms', 'Standard_A1_v2', 'Standard_A2m_v2',
                        'Standard_A2_v2', 'Standard_A4m_v2', 'Standard_A4_v2',
                        'Standard_A8m_v2', 'Standard_A8_v2', 'Basic_A0',
                        'Basic_A1', 'Basic_A2', 'Basic_A3', 'Basic_A4',
                        'Standard_A8', 'Standard_A9', 'Standard_A10',
                        'Standard_A11']
...
class FakeAzureConfig(UserDict):
    ...
    def instance_id(self):
        ...
        template = '/subscriptions/{uuid}/resourceGroups/{group}/providers/' \
                   + '{service}/{resource_type}/{name}'

        return self._get_prop('instance_id', template.format(
    ...
    def meter_category(self):
        ...
        return self._get_prop('meter_category',
    ...
    def meter_subcategory(self):
        ...
        return self._get_prop('meter_subcategory',
                              random.choice(list(AZURE_METERS[self.meter_name][self.meter_category])))

    @property
    def resource(self):
        """Return the resource name."""
        return self._get_prop('resource',
                              random.choice(AZURE_RESOURCES[self.resource_service]))
    ...
    def tags(self):
        ...
        new_tags = {key: self.fake.word()
                    for key in {self.fake.word()
...
class AzureReportDataGenerator:
    ...
    def _cost_entry_product(self):
        ...
        obj = AzureCostEntryProductService(instance_id=self.config.instance_id,
    ...
    def _cost_entry_line_item_daily(self, report_date=None):
        ...
        if report_date:
            ...
            usage_dt = self.fake.date_time_between_dates(self.dh.this_month_start,
                                                         self.dh.today)
    ...
    def _cost_entry_line_item_daily_summary(self, report_date=None):
        ...
        obj.save()
        # LOG.critical('YYY: %s', obj)
        return obj

    def select_tags(self):
        """Return a random selection of the defined tags."""
        return {key: self.config.tags[key]
