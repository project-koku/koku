...
class AzureReportQueryHandlerTest(IamTestCase):
    ...
    def test_execute_take_defaults(self):
        ...
        query_params = {}
        handler = AzureReportQueryHandler(query_params, '', self.tenant,
                                          **{'report_type': 'costs'})
        query_output = handler.execute_query()
        self.assertIsNotNone(query_output.get('data'))
        self.assertIsNotNone(query_output.get('total'))
    ...
    def test_execute_query_current_month_by_service(self):
        ...
        handler = AzureReportQueryHandler(query_params, '?group_by[service_name]=*',
                                          self.tenant,
                                          **{'report_type': 'costs'})
        query_output = handler.execute_query()
    ...
    def test_execute_query_by_filtered_service(self):
        ...
        handler = AzureReportQueryHandler(query_params,
                                          f'?group_by[service_name]={service}',
                                          self.tenant,
                                          **{'report_type': 'costs'})
        query_output = handler.execute_query()
        data = query_output.get('data')
    ...
    def test_execute_query_current_month_by_subscription_guid(self):
        ...
        handler = AzureReportQueryHandler(query_params, '?group_by[subscription_guid]=*',
                                          self.tenant,
                                          **{'report_type': 'costs'})
        query_output = handler.execute_query()
        data = query_output.get('data')
    ...
    def test_execute_query_by_subscription_guid_by_service(self):
        ...
        query_params = {'filter':
                        ...
                        'group_by': {'subscription_guid': ['*'],
                                     'service_name': ['*']}}
        query_string = '?group_by[subscription_guid]=*&group_by[service_name]=*'
        handler = AzureReportQueryHandler(query_params, query_string,
                                          self.tenant,
                                          **{'report_type': 'costs'})
        query_output = handler.execute_query()
        data = query_output.get('data')
    ...
    def test_execute_query_curr_month_by_subscription_guid_w_limit(self):
        ...
        query_params = {'filter':
                        ...
                        'group_by': {'subscription_guid': ['*']}}
        handler = AzureReportQueryHandler(query_params, '?group_by[subscription_guid]=*&filter[limit]=2',
                                          self.tenant,
                                          **{'report_type': 'costs'})
        query_output = handler.execute_query()
        data = query_output.get('data')
    ...
    def test_execute_query_curr_month_by_filtered_resource_location(self):
        ...
        handler = AzureReportQueryHandler(query_params,
                                          f'?group_by[resource_location]={location}',
                                          self.tenant,
                                          **{'report_type': 'costs'})
        query_output = handler.execute_query()
        data = query_output.get('data')
    ...
    def test_execute_query_curr_month_by_subscription_guid_w_limit_csv(self):
        ...
        cmonth_str = self.dh.this_month_start.strftime('%Y-%m')
        self.assertEqual(len(data[0].get('subscription_guids')), 3)
        for data_item in data:
    ...
    def test_execute_query_w_delta(self):
        ...
        handler = AzureReportQueryHandler(query_params,
                                          '?group_by[subscription_guid]=*&delta=cost',
                                          self.tenant,
                                          **{'report_type': 'costs'})
    ...
    def test_execute_query_orderby_delta(self):
        ...
        query_params = {'filter':
                        ...
                        'delta': 'cost'}
        handler = AzureReportQueryHandler(query_params,
                                          '?group_by[subscription_guid]=*&order_by[delta]=asc&delta=True',
                                          self.tenant,
                                          **{'report_type': 'costs'})
        query_output = handler.execute_query()
        data = query_output.get('data')
    ...
    def test_percent_delta(self):
        ...
        rqh = AzureReportQueryHandler({}, '', self.tenant, report_type='costs')
    ...
    def test_rank_list_by_subscription_guid(self):
        ...
        expected = [
            {'subscription_guid': '1', 'total': 5, 'rank': 1},
            {'subscription_guid': '2', 'total': 4, 'rank': 2},
            {'subscription_guid': '2 Others', 'cost': 0, 'markup_costs': 0,
    ...
    def test_rank_list_by_service_name(self):
        ...
        query_params = {'filter':
                        {'resolution': 'monthly', 'time_scope_value': -1,
                         'time_scope_units': 'month', 'limit': 2},
                        'group_by': {'service_name': ['*']}}
        handler = AzureReportQueryHandler(query_params, '?group_by[service_name]=*&filter[limit]=2',
                                          self.tenant,
                                          **{'report_type': 'costs'})
        data_list = [
        ...
        expected = [
            ...
            {'cost': 0, 'derived_cost': 0, 'infrastructure_cost': 0,
             'markup_costs': 0, 'service_name': '2 Others', 'total': 5, 'rank': 3}
        ]
        ranked_list = handler._ranked_list(data_list)
        self.assertEqual(ranked_list, expected)
    ...
    def test_rank_list_with_offset(self):
        ...
        handler = AzureReportQueryHandler(query_params,
                                          '?group_by[subscription_guid]=*&filter[limit]=2&filter[offset]=1',
                                          self.tenant,
                                          **{'report_type': 'costs'})
        data_list = [
            {'subscription_guid': '1', 'total': 5, 'rank': 1},
    ...
    def test_query_costs_with_totals(self):
        ...
        query_string = '?filter[resolution]=monthly&' + \
                       ...
                       'group_by[subscription_guid]=*'
        handler = AzureReportQueryHandler(query_params, query_string, self.tenant,
                                          report_type='costs')
        query_output = handler.execute_query()
        data = query_output.get('data')
        self.assertIsNotNone(data)
