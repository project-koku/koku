...
from api.report.test.ocp.test_ocp_query_handler import OCPReportQueryHandlerTest
from reporting.models import OCPUsageLineItemDaily


class OCPReportQueryHandlerCPUTest(OCPReportQueryHandlerTest):
    ...
    def test_execute_sum_query(self):
        ...
        query_params = {}
        handler = OCPReportQueryHandlerCPU(
            query_params,
            '',
            self.tenant,
            **{'report_type': 'cpu'}
