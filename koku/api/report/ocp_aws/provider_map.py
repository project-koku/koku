        ...
        self._mapping = [
            {
                ...
                'report_type': {
                    ...
                    'costs_by_project': {
                        ...
                        'cost_units_key': 'currency_code',
                        'cost_units_fallback': 'USD',
                        'sum_columns': ['infrastructure_cost', 'project_markup_cost',
                                        'derived_cost', 'cost'],
                        'default_ordering': {'cost': 'desc'},
                    },
                    'storage': {
                    ...
                    'storage_by_project': {
                        ...
                        'usage_units_key': 'unit',
                        'usage_units_fallback': 'GB-Mo',
                        'sum_columns': ['usage', 'cost', 'infrastructure_cost', 'derived_cost', 'project_markup_cost'],
                        'default_ordering': {'usage': 'desc'},
                    },
                    'instance_type': {
                        'aggregates': {
                    ...
                    'instance_type_by_project': {
                        ...
                        'count_units_fallback': 'instances',
                        'sum_columns': ['usage', 'cost', 'infrastructure_cost',
                                        'project_markup_cost', 'derived_cost', 'count'],
                        'default_ordering': {'usage': 'desc'},
                    },
                },
