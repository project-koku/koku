        ...
        self._mapping = [
            {
                ...
                "annotations": {
                    ...
                    "org_unit": "organizational_unit__org_unit_id",
                },
                "end_date": "usage_end",
                "filters": {
                    "account": [
                    ...
                    "org_unit": {"field": "organizational_unit__org_unit_id", "operation": "icontains"},
                },
                "group_by_options": ["service", "account", "region", "az", "product_family", "org_unit"],
                "tag_column": "tags",
                "report_type": {
                    "costs": {
                        "aggregates": {
                        ...
                        "annotations": {
                            ...
                            "cost_usage": Sum(
                                Value(0, output_field=DecimalField()) + Value(0, output_field=DecimalField())
                            ),
                            "cost_markup": Sum(
                                Coalesce(F("markup_cost"), Value(0, output_field=DecimalField()))
                                + Value(0, output_field=DecimalField())
