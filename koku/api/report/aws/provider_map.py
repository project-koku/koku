                ...
                'report_type': {
                    'costs': {
                        'aggregates': {
                            ...
                            'cost': Sum(ExpressionWrapper(F('unblended_cost') + F('markup_cost'), output_field=DecimalField())),
                        },
                        ...
                        'delta_key': {'cost': Sum(ExpressionWrapper(F('unblended_cost') + F('markup_cost'), output_field=DecimalField()))},
                        'filter': [{}],
