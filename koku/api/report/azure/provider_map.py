                ...
                "report_type": {
                    ...
                    "instance_type": {
                        ...
                        "annotations": {
                            ...
                            "usage": Sum("usage_quantity"),
                            "usage_units": Coalesce(Max("unit_of_measure"), Value("Hours")),
                            "source_uuid": ArrayAgg(F("source_uuid"), distinct=True),
                        },
                        "delta_key": {"usage": Sum("usage_quantity")},
                        "filter": [
                            {"field": "instance_type", "operation": "isnull", "parameter": False},
                            {"field": "unit_of_measure", "operation": "exact", "parameter": "Hours"},
                        ],
                        "group_by": ["instance_type"],
                        "cost_units_key": "currency",
                        "cost_units_fallback": "USD",
                        "usage_units_key": "unit_of_measure",
                        "usage_units_fallback": "Hours",
                    ...
                    "storage": {
                        ...
                        "annotations": {
                            ...
                            "cost_units": Coalesce(Max("currency"), Value("USD")),
                            "usage": Sum("usage_quantity"),
                            "usage_units": Coalesce(Max("unit_of_measure"), Value("GB/Month")),
                            "source_uuid": ArrayAgg(F("source_uuid"), distinct=True),
                        },
                        "delta_key": {"usage": Sum("usage_quantity")},
                        "filter": [
                            {"field": "service_name", "operation": "icontains", "parameter": "Storage"},
                            {"field": "unit_of_measure", "operation": "icontains", "parameter": "/Month"},
                        ],
                        "cost_units_key": "currency",
                        "cost_units_fallback": "USD",
                        "usage_units_key": "unit_of_measure",
                        "usage_units_fallback": "GB/Month",
