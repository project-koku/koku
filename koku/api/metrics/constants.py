...
OCP_METRIC_CPU_CORE_EFFECTIVE_HOUR = "cpu_core_effective_per_hour"
OCP_METRIC_MEM_GB_USAGE_HOUR = "memory_gb_usage_per_hour"
OCP_METRIC_MEM_GB_REQUEST_HOUR = "memory_gb_request_per_hour"
OCP_METRIC_MEM_GB_EFFECTIVE_HOUR = "memory_gb_effective_per_hour"
...
METRIC_CHOICES = (
    ...
    (OCP_METRIC_CPU_CORE_EFFECTIVE_HOUR, OCP_METRIC_CPU_CORE_EFFECTIVE_HOUR),
    (OCP_METRIC_MEM_GB_USAGE_HOUR, OCP_METRIC_MEM_GB_USAGE_HOUR),
    (OCP_METRIC_MEM_GB_REQUEST_HOUR, OCP_METRIC_MEM_GB_REQUEST_HOUR),
    (OCP_METRIC_MEM_GB_EFFECTIVE_HOUR, OCP_METRIC_MEM_GB_EFFECTIVE_HOUR),
...
COST_MODEL_METRIC_MAP = [
    ...
    {
        "source_type": "OCP",
        "metric": "cpu_core_effective_per_hour",
        "label_metric": "CPU",
        "label_measurement": "Effective",
        "label_measurement_unit": "core-hours",
        "default_cost_type": "Supplementary",
    },
    {
    ...
    {
        "source_type": "OCP",
        "metric": "memory_gb_effective_per_hour",
        "label_metric": "Memory",
        "label_measurement": "Effective",
        "label_measurement_unit": "GB-hours",
        "default_cost_type": "Supplementary",
