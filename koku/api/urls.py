...
urlpatterns = [
    ...
    path("ingress/minimal-reports/", MinimalReportView.as_view(), name="minimal-reports"),
    path("ingress/minimal-reports/<source>/", MinimalReportDetailView.as_view(), name="minimal-reports-detail"),
