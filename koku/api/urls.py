...
urlpatterns = [
    ...
    path("settings/tags/", SettingsTagView.as_view(), name="settings"),
    path("settings/tags/enable/", SettingsEnableTagView.as_view(), name="settings"),
    path("settings/tags/disable/", SettingsDisableTagView.as_view(), name="settings"),
