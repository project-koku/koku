...
class CostGroupsQueryHandler:
    ...
    def _check_parameters_for_filter_param(self, q_param) -> None:
        ...
        filter_values = self.parameters.get_filter(q_param, _SENTINEL)
        if filter_values is not _SENTINEL:
    ...
    def _check_parameters_for_exclude_param(self, q_param):
        ...
        exclude_values = self.parameters.get_exclude(q_param, _SENTINEL)
        if exclude_values is not _SENTINEL:
