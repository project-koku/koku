SELECT
  *,
  ...
  CASE lower(tags::json->>'com_redhat_rhel_variant')
...
FROM
  (
    SELECT *,
      string_to_array(identity_timeinterval, '/') as time_split,
      COALESCE(
        (
...
WHERE tags::json->>'com_redhat_rhel' IS NOT NULL
