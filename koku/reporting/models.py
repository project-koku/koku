...
OCP_ON_AWS_TEMP_MANAGED_TABLES = {
    ...
    "aws_openshift_daily_resource_matched_temp",  # COST-5881
    "aws_openshift_daily_tag_matched_temp",  # COST-5881
...
OCP_ON_AZURE_TEMP_MANAGED_TABLES = {
    ...
    "azure_openshift_daily_resource_matched_temp",  # COST-5881
    "azure_openshift_daily_tag_matched_temp",  # COST-5881
...
OCP_ON_GCP_TEMP_MANAGED_TABLES = {
    ...
    "gcp_openshift_daily_resource_matched_temp",  # COST-5881
    "gcp_openshift_daily_tag_matched_temp",  # COST-5881
}
