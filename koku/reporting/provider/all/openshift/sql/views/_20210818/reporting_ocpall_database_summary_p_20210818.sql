DROP INDEX IF EXISTS ocpall_database_summary_p;
DROP MATERIALIZED VIEW IF EXISTS reporting_ocpall_database_summary_p;

CREATE MATERIALIZED VIEW reporting_ocpall_database_summary_p AS (
...
CREATE UNIQUE INDEX ocpall_database_summary_p
ON reporting_ocpall_database_summary_p (usage_start, cluster_id, usage_account_id, product_code)
;
