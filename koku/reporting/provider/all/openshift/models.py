...
class OCPAllCostLineItemProjectDailySummaryP(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["usage_start"], name="ocpallp_p_proj_usage_idx"),
            models.Index(fields=["namespace"], name="ocpallp_p_proj_namespace_idx"),
            models.Index(fields=["node"], name="ocpallp_p_proj_node_idx"),
            models.Index(fields=["resource_id"], name="ocpallp_p_proj_resource_idx"),
            GinIndex(fields=["pod_labels"], name="ocpallp_p_proj_pod_labels_idx"),
            models.Index(fields=["product_family"], name="ocpallp_p_proj_prod_fam_idx"),
...
# ======================================================
#  Materialized views built on partitioned models
# ======================================================

# Materialized Views for UI Reporting
class OCPAllCostSummaryP(models.Model):
    """A MATERIALIZED VIEW specifically for UI API queries.
    This table gives a daily breakdown of total cost.
    """
    ...
    class Meta:
        ...
        db_table = "reporting_ocpall_cost_summary_p"
        managed = False
...
class OCPAllCostSummaryByAccountP(models.Model):
    """A MATERIALIZED VIEW specifically for UI API queries.
    This table gives a daily breakdown of total cost by account.
    """
    ...
    class Meta:
        ...
        db_table = "reporting_ocpall_cost_summary_by_account_p"
        managed = False
...
class OCPAllCostSummaryByServiceP(models.Model):
    """A MATERIALIZED VIEW specifically for UI API queries.
    This table gives a daily breakdown of total cost by account.
    """
    ...
    class Meta:
        ...
        db_table = "reporting_ocpall_cost_summary_by_service_p"
        managed = False
...
class OCPAllCostSummaryByRegionP(models.Model):
    """A MATERIALIZED VIEW specifically for UI API queries.
    This table gives a daily breakdown of total cost by region.
    """
    ...
    class Meta:
        ...
        db_table = "reporting_ocpall_cost_summary_by_region_p"
        managed = False
...
class OCPAllComputeSummaryP(models.Model):
    """A summarized view of OCP on All infrastructure cost for products in the compute service category."""

    class Meta:
        """Meta for OCPAllComputeSummary."""

        db_table = "reporting_ocpall_compute_summary_p"
        managed = False
...
class OCPAllDatabaseSummaryP(models.Model):
    """A summarized view of OCP on All infrastructure cost for products in the database service category."""

    class Meta:
        """Meta for OCPAllDatabaseSummary."""

        db_table = "reporting_ocpall_database_summary_p"
        managed = False
...
class OCPAllNetworkSummaryP(models.Model):
    """A summarized view of OCP on All infrastructure cost for products in the network service category."""

    class Meta:
        """Meta for OCPAllNetworkSummary."""

        db_table = "reporting_ocpall_network_summary_p"
        managed = False
...
class OCPAllStorageSummaryP(models.Model):
    """A summarized view of OCP on All infrastructure cost for products in the storage service category."""

    class Meta:
        """Meta for OCPAllStorageSummary."""

        db_table = "reporting_ocpall_storage_summary_p"
        managed = False
