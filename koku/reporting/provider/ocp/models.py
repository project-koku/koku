...
class OCPGpuSummaryP(models.Model):
    """A summarized partitioned table for GPU usage queries.

    This table gives a daily breakdown of GPU usage.
    """
    ...
    gpu_pod_uptime = models.DecimalField(max_digits=33, decimal_places=15, null=True)  # seconds

    # Count of distinct GPUs
    gpu_count = models.IntegerField(null=True)

    # Cost fields (will be populated by cost model)
