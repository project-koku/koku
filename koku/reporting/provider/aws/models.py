...
class AWSCostEntryLineItemMonthlySummaryByEC2Compute(models.Model):
    ...
    class Meta:
        """Meta for AWSCostEntryLineItemMonthlySummaryByEC2ComputeResource."""

        db_table = "reporting_awscostentrylineitem_monthly_summary_by_ec2_compute"

        indexes = [
            # 'ec2c' for EC2 Compute
            models.Index(fields=["usage_start"], name="ec2mc_usage_start_idx"),
            models.Index(fields=["usage_account_id"], name="ec2mc_usage_account_id_idx"),
            models.Index(fields=["account_alias"], name="ec2mc_account_alias_idx"),
            models.Index(fields=["resource_id"], name="ec2mc_resource_id_idx"),
            models.Index(fields=["instance_name"], name="ec2mc_instance_name_idx"),
            models.Index(fields=["instance_type"], name="ec2mc_instance_type_idx"),
            models.Index(fields=["region"], name="ec2mc_region_idx"),
            models.Index(fields=["operating_system"], name="ec2mc_os_idx"),
            GinIndex(fields=["tags"], name="ec2mc_tags_idx"),
            GinIndex(fields=["cost_category"], name="ec2mc_cost_category_idx"),
        ]
