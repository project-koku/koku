...
CREATE MATERIALIZED VIEW reporting_gcp_compute_summary_by_region AS (
    ...
    GROUP BY usage_start, instance_type, account_id, region, invoice_month
)
WITH DATA
    ;

CREATE UNIQUE INDEX gcp_compute_summary_region
    ON reporting_gcp_compute_summary_by_region (usage_start, instance_type, account_id, region, invoice_month)
;
