    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizational_unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='reporting.awsorganizationalunit')),
            ],
            options={
                'db_table': 'reporting_awscostentrylineitem_summary_by_ec2_compute_resource',
                'indexes': [models.Index(fields=['usage_start'], name='ec2ci_usage_start_idx'), models.Index(fields=['usage_account_id'], name='ec2ci_usage_account_id_idx'), models.Index(fields=['account_alias'], name='ec2ci_account_alias_idx'), models.Index(fields=['resource_id'], name='ec2ci_resource_id_idx'), models.Index(fields=['instance_type'], name='ec2ci_instance_type_idx'), models.Index(fields=['instance_name'], name='ec2ci_instance_name_idx'), models.Index(fields=['region'], name='ec2ci_region_idx'), models.Index(fields=['operating_system'], name='ec2ci_os_idx'), django.contrib.postgres.indexes.GinIndex(fields=['tags'], name='ec2ci_tags_idx'), django.contrib.postgres.indexes.GinIndex(fields=['cost_category'], name='ec2ci_cost_category_idx')],
            },
        ),
    ]
