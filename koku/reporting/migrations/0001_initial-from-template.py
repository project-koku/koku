        ...
        migrations.RunSQL(
            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    options={"db_table": "reporting_awscostentrylineitem_daily_summary", "managed": False},
                ),
                migrations.CreateModel(
                    name="AWSCostSummary",
                    fields=[
                ...
                migrations.CreateModel(
                    ...
                    options={"db_table": "reporting_azurecostentrylineitem_daily_summary", "managed": False},
                ),
                migrations.CreateModel(
                ...
                migrations.CreateModel(
                    ...
                    options={"db_table": "reporting_gcpcostentrylineitem_daily_summary", "managed": False},
                ),
                migrations.CreateModel(
                    name="GCPCostSummary",
                    fields=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "monthly_cost_type",
                            models.TextField(
                                choices=[("Node", "Node"), ("Cluster", "Cluster"), ("PVC", "PVC")], null=True
                            ),
                        ),
                        ("source_uuid", models.UUIDField(null=True)),
                    ],
                    options={"db_table": "reporting_ocpusagelineitem_daily_summary", "managed": False},
                ),
                migrations.CreateModel(
                ...
                migrations.AlterUniqueTogether(
                    name="partitionedtable", unique_together={("schema_name", "table_name")}
                ),
                migrations.AddField(
                ...
                migrations.AddField(
                    ...
                    name="report",
                    field=models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="reporting.ocpusagereport"
                    ),
                ),
                migrations.AddField(
                    model_name="ocpnamespacelabellineitem",
                ...
                migrations.AddField(
                    ...
                    field=models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="reporting.azurecostentrybill"
                    ),
                ),
                migrations.AddField(
                    model_name="ocpazuretagssummary",
                ...
                migrations.AddField(
                    ...
                    name="cost_entry_bill",
                    field=models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="reporting.awscostentrybill"
                    ),
                ),
                migrations.AddField(
                    model_name="ocpawstagssummary",
                ...
                migrations.AddField(
                    ...
                    name="cost_entry_bill",
                    field=models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="reporting.gcpcostentrybill"
                    ),
                ),
                migrations.AlterUniqueTogether(
                    name="gcpcostentryproductservice",
                ...
                migrations.AlterUniqueTogether(
                    name="ocpusagereport", unique_together={("report_period", "interval_start")}
                ),
                migrations.AlterUniqueTogether(
                ...
                migrations.AddIndex(
                    model_name="ocpusagelineitemdaily", index=models.Index(fields=["pod"], name="pod_idx")
                ),
                migrations.AddIndex(
                    model_name="ocpusagelineitemdaily",
                ...
                migrations.AddIndex(
                    model_name="ocpstoragelineitemdaily",
                    index=models.Index(
                        fields=["node"], name="ocp_storage_li_node_idx", opclasses=["varchar_pattern_ops"]
                    ),
                ),
                migrations.AlterUniqueTogether(
                ...
                migrations.AddIndex(
                    model_name="ocpnodelabellineitemdaily",
                    index=django.contrib.postgres.indexes.GinIndex(
                        fields=["node_labels"], name="ocplblnitdly_node_labels"
                    ),
                ),
                migrations.AlterUniqueTogether(name="ocpnodelabellineitem", unique_together={("report", "node")}),
                migrations.AlterUniqueTogether(
                    name="ocpnamespacelabellineitem", unique_together={("report", "namespace")}
                ),
                migrations.AlterUniqueTogether(
                    name="ocpazuretagssummary",
                    unique_together={
                ...
                migrations.AddIndex(
                    model_name="ocpazurecostlineitemprojectdailysummary",
                    index=models.Index(
                        fields=["node"], name="ocpazure_proj_node_idx", opclasses=["varchar_pattern_ops"]
                    ),
                ),
                migrations.AddIndex(
                    model_name="ocpazurecostlineitemprojectdailysummary",
                ...
                migrations.AddIndex(
                    model_name="ocpazurecostlineitemprojectdailysummary",
                    index=django.contrib.postgres.indexes.GinIndex(
                        fields=["pod_labels"], name="ocpazure_proj_pod_labels_idx"
                    ),
                ),
                migrations.AddIndex(
                    model_name="ocpazurecostlineitemprojectdailysummary",
                ...
                migrations.AddIndex(
                    model_name="ocpawscostlineitemprojectdailysummary",
                    index=models.Index(
                        fields=["node"], name="cost_proj_sum_node_idx", opclasses=["varchar_pattern_ops"]
                    ),
                ),
                migrations.AddIndex(
                    model_name="ocpawscostlineitemprojectdailysummary",
                ...
                migrations.AddIndex(
                    model_name="ocpawscostlineitemprojectdailysummary",
                    index=django.contrib.postgres.indexes.GinIndex(
                        fields=["pod_labels"], name="cost_proj_pod_labels_idx"
                    ),
                ),
                migrations.AddIndex(
                    model_name="ocpawscostlineitemprojectdailysummary",
                ...
                migrations.AddIndex(
                    model_name="ocpawscostlineitemdailysummary",
                    index=models.Index(
                        fields=["node"], name="cost_summary_node_idx", opclasses=["varchar_pattern_ops"]
                    ),
                ),
                migrations.AddIndex(
                    model_name="ocpawscostlineitemdailysummary",
                ...
                migrations.AddIndex(
                    model_name="awscostentrylineitemdaily",
                    index=models.Index(fields=["resource_id"], name="resource_id_idx"),
                ),
                migrations.AddIndex(
                    model_name="awscostentrylineitemdaily",
