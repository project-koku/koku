# Generated by Django 3.1.3 on 2020-12-01 18:12
import uuid
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(name="gcptagssummary", unique_together={("key", "cost_entry_bill", "project")}),
        migrations.AddIndex(
            model_name="gcpcostentrylineitemdailysummary",
        ...
        migrations.AddIndex(
            model_name="gcpcostentrylineitemdailysummary",
            index=models.Index(fields=["project"], name="gcp_summary_project_idx"),
        ),
        migrations.AddIndex(
            model_name="gcpcostentrylineitemdailysummary",
            index=models.Index(fields=["cost_entry_product"], name="gcp_summary_product_idx"),
        ),
        migrations.AddIndex(
            model_name="gcpcostentrylineitemdaily",
