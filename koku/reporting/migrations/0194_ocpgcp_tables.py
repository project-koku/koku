# Generated by Django 3.1.13 on 2021-10-06 13:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            code=set_partition_mode,
            reverse_code=unset_partition_mode
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster_aliases', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), size=None)),
                ('namespaces', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), size=None)),
                ('nodes', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), null=True, size=None)),
            ],
            options={
        ...
        migrations.RunPython(
            code=unset_partition_mode,
            reverse_code=set_partition_mode
        ),
    ]
