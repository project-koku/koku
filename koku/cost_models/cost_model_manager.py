...
class CostModelManager:
    ...
    def _classify_incoming_rates(self, rates_data, existing_by_uuid, existing_by_name, all_existing_names):
    ...
    def _sync_rate_table(self, price_list, rates_data):
        ...
        if to_update:
            Rate.objects.bulk_update([obj for obj, _ in to_update], update_fields)
