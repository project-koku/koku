...
class KokuCacheTest(IamTestCase):
    ...
    def test_get_cache_timeout(self, patch_ttl):
        ...
        set_cached_reprocess_by_provider_type(Provider.PROVIDER_AWS)
        value, _ = get_cached_reprocess_by_provider_type(Provider.PROVIDER_AWS)
        self.assertEqual(value, Provider.PROVIDER_AWS)
        # Test double set
        self.assertFalse(set_cached_reprocess_by_provider_type(Provider.PROVIDER_AWS))
