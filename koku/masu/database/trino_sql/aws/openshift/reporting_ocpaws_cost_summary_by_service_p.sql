INSERT INTO postgres.{{schema_name | sqlsafe}}.reporting_ocpaws_cost_summary_by_service_p (
    id,
    usage_start,
    usage_end,
    cluster_id,
    ...
    FROM hive.{{schema_name | sqlsafe}}.reporting_ocpawscostlineitem_project_daily_summary_p
