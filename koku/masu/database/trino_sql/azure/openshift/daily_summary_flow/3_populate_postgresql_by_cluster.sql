DELETE FROM postgres.{{schema | sqlsafe}}.reporting_ocpazurecostlineitem_project_daily_summary_p
WHERE source_uuid = cast({{cloud_provider_uuid}} as UUID)
