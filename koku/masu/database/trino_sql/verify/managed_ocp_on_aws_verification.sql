...
(
    ...
    FROM hive.{{trino_schema_prefix | sqlsafe}}{{schema | sqlsafe}}.managed_aws_openshift_daily as managed_ocpcloud
...
(
    ...
    FROM hive.{{trino_schema_prefix | sqlsafe}}{{schema | sqlsafe}}.aws_openshift_daily as parquet_table
