...
JOIN hive.{{ schema_name | sqlsafe}}.reporting_ocpusagelineitem_daily_summary as ocp
...
LEFT JOIN hive.{{schema_name | sqlsafe}}.reporting_ocpgcpcostlineitem_project_daily_summary_temp AS pds
