...
SELECT gcp.uuid as gcp_uuid,
    ...
    CASE
        ...
        THEN cast(max(gcp.usage_amount_in_pricing_units) * 1.073741824 AS decimal(24,9)) -- Convert to gigabyte
        ELSE cast(max(gcp.usage_amount_in_pricing_units) AS decimal(24,9))
    END as usage_amount,
