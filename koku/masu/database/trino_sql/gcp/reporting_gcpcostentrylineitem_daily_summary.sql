...
SELECT uuid() as uuid,
    ...
    date(usage_start_time AT TIME ZONE '{{provider_timezone | sqlsafe}}') as usage_start,
    date(usage_start_time AT TIME ZONE '{{provider_timezone | sqlsafe}}') as usage_end,
...
GROUP BY billing_account_id,
    ...
    service_id,
    sku_id,
    date(usage_start_time AT TIME ZONE '{{provider_timezone | sqlsafe}}'),
    date(usage_end_time AT TIME ZONE '{{provider_timezone | sqlsafe}}'),
    location_region,
