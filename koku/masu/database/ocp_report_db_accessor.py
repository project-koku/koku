...
class OCPReportDBAccessor(SQLScriptAtomicExecutorMixin, ReportDBAccessorBase):
    ...
    def get_nodes_trino(self, source_uuid, start_date, end_date):
        ...
        sql = f"""
            ...
            GROUP BY ocp.node,
                ocp.resource_id
        """  # noqa: E501
        sql_params = {"schema": self.schema, "start": start_date, "end": end_date, "provider_uuid": source_uuid}
        return self._execute_trino_raw_sql_query(sql, sql_params=sql_params, log_ref="get_nodes_trino")
    ...
    def get_pvcs_trino(self, source_uuid, start_date, end_date):
        ...
        """
        sql_params = {"schema": self.schema, "start": start_date, "end": end_date, "provider_uuid": source_uuid}
        return self._execute_trino_raw_sql_query(sql, sql_params=sql_params, log_ref="get_pvcs_trino")
    ...
    def get_projects_trino(self, source_uuid, start_date, end_date):
        ...
        """
        sql_params = {"schema": self.schema, "start": start_date, "end": end_date, "provider_uuid": source_uuid}
        projects = self._execute_trino_raw_sql_query(sql, sql_params=sql_params, log_ref="get_projects_trino")
    ...
    def get_max_min_timestamp_from_parquet(self, source_uuid, start_date, end_date):
        ...
        timestamps = self._execute_trino_raw_sql_query(
            sql, sql_params=sql_params, log_ref="get_max_min_timestamp_from_parquet"
        )
