...
CREATE TEMPORARY TABLE reporting_ocpusagelineitem_daily_{{uuid | sqlsafe}} AS (
    ...
    SELECT  li.report_period_id,
        ...
        sum(li.pod_effective_usage_cpu_core_seconds) as pod_effective_usage_cpu_core_seconds,
        ...
        sum(li.pod_effective_usage_memory_byte_seconds) as pod_effective_usage_memory_byte_seconds,
