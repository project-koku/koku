...
FROM (
    ...
    FROM (
        SELECT lids.uuid,
            ...
            WHEN {{metric}}='cpu_core_effective_per_hour' THEN lids.pod_effective_usage_cpu_core_hours
            ...
            WHEN {{metric}}='memory_gb_effective_per_hour' THEN lids.pod_effective_usage_memory_gigabyte_hours
