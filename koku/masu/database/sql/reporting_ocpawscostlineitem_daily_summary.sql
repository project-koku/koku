-- The Python Jinja string variable subsitutions
-- optionally filters AWS and OCP data by provider/source with:
--        {% if cluster_id %}
--        AND cluster_id = {{cluster_id}}
--        {% endif %}
-- Ex aws where clause: 'AND cost_entry_bill_id IN (1, 2, 3)'
-- Ex ocp  where clause "AND cluster_id = 'abcd-1234`"
