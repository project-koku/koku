...
INSERT INTO {{schema | sqlsafe}}.reporting_ocpusagelineitem_daily_summary (
    ...
    SELECT uuid_generate_v4() as uuid,
        ...
        sum(ocp_aws.blended_cost + ocp_aws._blended) AS infrastructure_raw_cost_blended,
        sum(ocp_aws.savingsplan_effective_cost + ocp_aws.markup_cost_amortized) AS infrastructure_raw_cost_amortized,
