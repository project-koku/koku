...
CREATE TEMPORARY TABLE reporting_ocpusagelineitem_daily_summary_{{uuid | sqlsafe}} AS (
    SELECT uuid_generate_v4() as uuid,
        ...
        sum(greatest(li.pod_usage_cpu_core_seconds, li.pod_request_cpu_core_seconds)) / 3600.0  as pod_effective_usage_cpu_core_hours,
        ...
        sum(greatest(li.pod_usage_memory_byte_seconds, li.pod_request_memory_byte_seconds)) / 3600.0 * power(2, -30) as pod_effective_usage_memory_gigabyte_hours,
