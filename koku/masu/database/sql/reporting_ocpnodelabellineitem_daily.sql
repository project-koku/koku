...
CREATE TEMPORARY TABLE reporting_ocpnodelabellineitem_daily_{{uuid | sqlsafe}} AS (
    ...
    FROM {{schema_name | sqlsafe}}.reporting_ocpnodelabellineitem AS li
    JOIN {{schema_name | sqlsafe}}.reporting_ocpusagereport AS ur
...
DELETE FROM {{schema_name | sqlsafe}}.reporting_ocpnodelabellineitem_daily
...
INSERT INTO {{schema_name | sqlsafe}}.reporting_ocpnodelabellineitem_daily (
    report_period_id,
    cluster_id,
    cluster_alias,
    usage_start,
