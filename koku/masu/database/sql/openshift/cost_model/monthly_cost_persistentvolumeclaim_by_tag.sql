...
SELECT uuid_generate_v4(),
    ...
    lids.volume_labels,
    max(lids.persistentvolumeclaim_capacity_gigabyte) as persistentvolumeclaim_capacity_gigabyte,
    max(lids.persistentvolumeclaim_capacity_gigabyte_months) as persistentvolumeclaim_capacity_gigabyte_months,
