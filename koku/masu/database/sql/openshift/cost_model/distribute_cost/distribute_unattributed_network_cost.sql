...
cte_line_items as (
    ...
    GROUP BY filtered.usage_start, filtered.node, filtered.namespace, filtered.cluster_id, cost_category_id, filtered.data_source, filtered.pod_labels, filtered.volume_labels, filtered.all_labels
)
