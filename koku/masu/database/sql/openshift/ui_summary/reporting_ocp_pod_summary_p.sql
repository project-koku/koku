...
WITH line_items AS (
    SELECT
        ...
        distributed_cost,
        data_source,
        -- Window: sums from base rows (rate_type IS NULL) at cluster+date level.
