...
INSERT INTO {{schema | sqlsafe}}.reporting_ocp_gpu_summary_p (
    ...
    SELECT uuid_generate_v4() as id,
        ...
        max((all_labels->>'mig-slice-count')::integer) as mig_slice_count,
        max((all_labels->>'parent-gpu-max-slices')::integer) as parent_gpu_max_slices,
        max(all_labels->>'parent-gpu-uuid') as parent_gpu_uuid,
