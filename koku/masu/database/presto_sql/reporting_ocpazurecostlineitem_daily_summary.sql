...
SELECT
    ...
    END as namespace,
    pds.node,
    (SUM(pretax_cost) - SUM(pod_cost)) as pod_cost,
    max(subscription_guid) as subscription_guid,
...
FROM hive.{{schema | sqlsafe}}.reporting_ocpazurecostlineitem_project_daily_summary as pds
