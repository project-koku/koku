...
CREATE TABLE __reporting_ocpnodelabellineitem_daily_{{uuid | sqlsafe}} AS (
    ...
    FROM hive.{{schema | sqlsafe}}.openshift_node_labels_line_items AS li
    ...
    LEFT JOIN postgres.public.api_provider as p
