...
DELETE FROM postgres.{{schema | sqlsafe}}.reporting_ocpgcp_cost_summary_by_account_p
...
INSERT INTO postgres.{{schema | sqlsafe}}.reporting_ocpgcp_cost_summary_by_account_p (
    id,
    cluster_id,
    cluster_alias,
    usage_start,
