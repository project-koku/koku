...
GCP_REPORT_TABLE_MAP = {
    ...
    "ocp_on_gcp_daily_summary": "reporting_ocpgcpcostlineitem_daily_summary",
    "ocp_on_gcp_project_daily_summary": "reporting_ocpgcpcostlineitem_project_daily_summary",
