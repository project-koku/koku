...
class ReportManifestDBAccessor(KokuDBAccess):
    ...
    def purge_expired_report_manifest(self, provider_type, billing_period_start_datetime):
        """
    ...
    def purge_expired_report_manifest_provider_uuid(self, provider_uuid, billing_period_start_datetime):
        """
