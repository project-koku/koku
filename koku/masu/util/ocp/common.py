...
def match_openshift_labels(tag_dict, matched_tags, cluster_id, cluster_alias, nodes, projects, has_special_tags):
    ...
    if has_special_tags:
        for key, value in tag_dict.items():
            ...
            if key.lower() == "openshift_project" and value.lower() in projects:
                return tag
