...
class OCPReportChargeUpdaterTest(MasuTestCase):
    ...
    def test_update_summary_charge_info_mem_cpu(self, mock_markup, mock_rate_map):
        ...
        self.updater.update_summary_charge_info(usage_period.report_period_start, usage_period.report_period_end)
            ...
            with schema_context(self.schema):
                for item in items:
                    ...
                    expected_project_markup_cost = (
                        derived_cost * openshift_markup["value"] / 100 + project_infra_cost * aws_markup["value"] / 100
                    )
