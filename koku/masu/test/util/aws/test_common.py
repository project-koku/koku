...
class TestAWSUtils(MasuTestCase):
    ...
    def test_delete_old_data_postgres_by_date(self, mock_get_accessor):
        ...
        mock_accessor.get_delete_by_manifestid_and_date_sql.return_value = "DELETE SQL"
        ...
        self.assertEqual(mock_accessor.get_delete_by_manifestid_and_date_sql.call_count, 3)
    ...
    def test_delete_old_data_postgres_by_date_table_not_exists(self, mock_get_accessor):
        ...
        self.assertEqual(mock_accessor.get_table_check_sql.call_count, 3)
        mock_accessor.get_delete_by_manifestid_and_date_sql.assert_not_called()
