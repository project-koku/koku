...
class AWSReportDownloaderTest(MasuTestCase):
    ...
    @patch("masu.util.aws.common.get_assume_role_session", return_value=FakeSession)
    def test_download_file(self, fake_session, mock_copy, mock_remove, mock_accessor):
        """Test the download file method."""
        mock_accessor.get_s3_csv_cleared.return_value = False
        ...
        mock_accessor.mark_s3_csv_cleared.assert_called()
