...
sns_subscription_confirm_headers = [('X-Amz-Sns-Topic-Arn', 'arn:aws:sns:us-east-1:589179999999:CostUsageNotificationDemo'),
...
sns_subscription_confirm_body_dict = {"Type" : "SubscriptionConfirmation",
...
sns_notification_headers = [('X-Amz-Sns-Message-Type', 'Notification'),
...
sns_notification_body_dict = {"Type" : "Notification",
