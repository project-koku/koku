...
class CostModelDBAccessorTest(MasuTestCase):
    ...
    def setUp(self):
        ...
        self.rates = [
            ...
            {"metric": {"name": "cpu_core_request_per_hour"}, "tiered_rates": [{"value": 3.5, "unit": "USD"}]},
            {"metric": {"name": "memory_gb_request_per_hour"}, "tiered_rates": [{"value": 4.5, "unit": "USD"}]},
            {"metric": {"name": "storage_gb_usage_per_month"}, "tiered_rates": [{"value": 5.5, "unit": "USD"}]},
            {"metric": {"name": "storage_gb_request_per_month"}, "tiered_rates": [{"value": 6.5, "unit": "USD"}]},
            {"metric": {"name": "node_cost_per_month"}, "tiered_rates": [{"value": 7.5, "unit": "USD"}]},
        ]
    ...
    def test_initializer(self):
        """Test initializer."""
        with CostModelDBAccessor(self.schema, self.provider_uuid, self.column_map) as cost_model_accessor:
