...
class AWSReportDBAccessorTest(MasuTestCase):
    ...
    # We won't have line items table after the trino migration
    ...
    # Line item tables won't be a thing when we switch to Trino
    ...
    #         LOG.info(line_item_query.query)
    ...
    # This table won't exist after trino migration
    ...
    # This uses old sql that pulls from the line items
    # table to populate the daily summary
    ...
    # TODO: This uses SQL that won't exist when we switch to Trino
    # def test_get_openshift_on_cloud_matched_tags(self):
    #     """Test that matched tags are returned."""
    #     # Create a matching tag value.
    #     dh = DateHelper()
    #     start_date = dh.this_month_start.date()
