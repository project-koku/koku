...
Deep-dive docs loaded only when a task needs them. Start with the **Task Router**
in [`AGENTS.md`](../../AGENTS.md), then open entries from this catalog.

| Topic | Doc |
|-------|-----|
| SQL / pipeline file map (start here for masu SQL) | [`sql-pipeline-index.md`](sql-pipeline-index.md) |
