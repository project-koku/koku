...
1. Define static exchange rates via the CRUD API (`/settings/currency/static-rates/`)
...
| v1.8 | 2026-04-28 | R8: updated CRUD API URL to `settings/currency/static-rates/`. |
