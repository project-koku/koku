...
**PRD**: PRD10 COST-575 Constant Currency
...
graph LR
    ...
    USER["Price List Admin"] -->|CRUD| SER["StaticExchangeRate<br/>(tenant schema)"]
...
| 4 | **No multi-hop conversion** | Per PRD: no chain conversion (e.g., USD→EUR→CNY) to avoid prioritization complexity |
