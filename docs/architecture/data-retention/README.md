...
| 6 | [docs-handoff-draft.md](docs-handoff-draft.md) | Docs handoff | Customer-facing draft: how on-prem admins control retention (UI/API/env). Not the per-table audit matrix. |
